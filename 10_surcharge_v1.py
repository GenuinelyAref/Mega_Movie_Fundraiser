...
# Credit option
radio_one = Radiobutton(root, text="Credit", variable=v, value=1).pack(side="top", pady=25)
# Cash option
radio_two = Radiobutton(root, text="Cash", variable=v, value=2).pack(side="top", pady=0)
